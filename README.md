...
```
seqbot run -flagptah=/path/to/flag.json -dingtoken=token1 -actionarchive=false
seqbot send -msgfile=message.md -dingtoken=token1
seqbot watch -debug -wfqlog=/path/to/WFQLog -dingtoken=token1 -dingtoken=token2 -actionsummary=false
```
